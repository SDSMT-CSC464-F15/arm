...
\title{{\color{MSBlue1} \rule{\linewidth}{0.5mm}}\\[2mm] {\huge \bfseries \color{MSBlue1} ARM Cluster }\\[-1mm] {\color{MSBlue1}\rule{\linewidth}{0.5mm}} \\  \vfill
{\LARGE \bfseries \color{MSBlue2} Senior Design Final Documentation }\\  \vfill 
{\color{MSBlue1} Team Name} }
\author{\color{MSBlue1}  Andrew Hoover \and \color{MSBlue1} Samantha Kranstz \and  \color{MSBlue1} Christine Sorensen }
...
\input{requirements.tex}%% Took out requirements, we don't need it CNS
...
%% Took out business plan, we don't need it CNS
